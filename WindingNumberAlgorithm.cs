...
namespace PointInQuadrilateral
{
    ...
    {
        // Finish this, try to find a simpler way to implement this check
        // Name the class IsPointWithinChecker, and this method CalculateWindingNumber
        ...
        public static bool PointLiesOnEdge(Coordinate point, List<Coordinate> coordinates)
        {
            int xp = point.X;
            int yp = point.Y;
